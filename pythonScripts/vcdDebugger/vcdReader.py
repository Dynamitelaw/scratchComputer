'''
I copied this from https://github.com/zylin/Verilog_VCD

I tried to install the Verilog_VCD package through pip, but for some reason I could not use any of the functions, despite sucessfully importing the module.
Since the entire module is just this one file, I just copied it into my repository.
    -Dynamitelaw
'''
